package com.littlepage.dbUtils;

import java.sql.*;

/**
 * Copyright (c) 2018 Shanghai University of Electric Power
 * @function:Operator database
 * @author:Little Page
 * @version:1.0
 * @isCompleted:true
 */
...
public class DBUtils {
	...
	/**
	 *connect to the database highschoollibrarysystem
	 * @return:Connection
	 */
	public static Connection getConnection(){
		...
		try {
			...
			conn=DriverManager.getConnection("jdbc:mysql:///railwaysystem","root","");
